...
Filtering an image by gabor wavelet is one of the widely used method for feature extraction. Convolutioning an image with gabor filters generates transformed images. Beolw image shows 200 gabor filters that can captures information from an images alomst as similar as human visual system do.

![gabor](/result_images/gabor_wavelet.jpg  "gabor")

After convolution with a few gabor filters, an image has transformed into different ones. 

![surfing_gabor](/result_images/surfing_gabor.png  "surfing_gabor")

* Code for featrue extraction from images using gabor wavelet 
For more codes about saving and importing the result using pickle, which is insanely fast, you can find those at my github. 

...
Each of the plotted MNIST test digits is quite well fitted into the target locations! Although digit 3 and 5 are not well splitted, it seems to be resolved if the number of training iteration increases.

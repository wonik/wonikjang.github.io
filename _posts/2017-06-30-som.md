...
Suppose your mission is to cluster colors, images, or text. Unsupervised learning(no label information is provided) can handle it, and for image clustering, the most widely used algorithm are Self-Organizing-MAP(SOM) and Adaptive Response Theory(ART). 
